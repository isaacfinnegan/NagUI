...
Ext.define('nagui_node.hostgroup',{
    extend: 'Ext.data.TreeModel',
    fields: [
        { name: 'text', mapping: 'name'},
        { name: 'status', convert: function(value,rec){

        }}
    ]
});
Ext.define('nagui_node.host',{
    extend: 'Ext.data.TreeModel',
    fields: [
        { name: 'text', mapping: 'name'},
        { name: 'status', convert: function(value,rec){
...
Ext.define('nagui_node.service',{
    extend: 'Ext.data.TreeModel',
    fields: [
        { name: 'text', mapping: 'description'},
        { name: 'status', mapping: 'plugin_output'}
    ]
});
Ext.define('nagui_node.servicegroup',{
    extend: 'Ext.data.TreeModel',
    fields: [
        { name: 'text', mapping: 'name'},
        { name: 'status', convert: function(value,rec){
...
Ext.define('nagios_node',
{
    ...
    fields: [ 
        ...
        // nagios_type determined based on fields returned. needs to be last since fields are processed in order
        {
            ...
            {
                if(node.data.text == 'Root' || node.data.text == 'Search' )
                { 
                    return;
                }
                ...
                // 	return nt;
                // }
                if ((typeof node.data.host_name != 'undefined' && node.data.host_name.length) || (typeof node.data.description != 'undefined' && node.data.description.length))
                {
                    nt = 'service';
                }
