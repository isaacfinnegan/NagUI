    ...
    toggleLiveLog: function(){
        ...
        this.liveTask=Ext.util.TaskManager.start({
            run: function(){
                ...
                this.getLogs({addRecords:true,rawquery: 'GET log|Columns: type host_name message lineno options contact_name service_description plugin_output state attempt class state_type time type command_name|Filter: time >= ' + time + NagUI.config.livelog.filter});
            },
            scope: this,
